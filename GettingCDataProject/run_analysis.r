  ...
  measurement_meanstd <-data.frame(cbind(msy,ms,my,meanstd))
  ...
  colname <-c("subject_activity","subject","activity", co1,co2,co3,co4,co5,co6,co7,co8,co9,co10,co11,co12,co13,co14,co15,co16,co17,co18)
  ...
  measurement_ms <-sapply(s,function(measurement_meanstd) colMeans(measurement_meanstd[,-c(1,2)]))
